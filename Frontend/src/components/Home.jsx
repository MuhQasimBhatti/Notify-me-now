...
const Home = () => {
  return (
    <div>
      <div className="landingPage"  style={{ padding:"7% 10%",}}>
        ...
        <div className="text-center " style={{ marginTop: "4rem" }}>
          ...
          >
            ...
            <img src={landingPage2} className="w-50 rounded-3"></img>
          </div>
          ...
          <div
            ...
            style={{ margin: "1rem" }}
          >
            <img src={landingPage3} className="w-100 d-lg-block d-none"></img>
            <p style={{textAlign: "start" }}>
              When IT processes fail, systems can descend into chaos very
              quickly. That's why it's important for notifications to reach the
              right staff members immediately.
              <br /> Automate your IT SMS notifications to send whenever a
              script fails and never miss an important outage (or worse: be
              alerted to it by your customers).
            </p>
            <img src={landingPage3} className="w-50 d-lg-none rounded-3" alt="Your Image" />
          </div>
          ...
          >
            ...
            <img src={landingPage4} className="w-50 rounded-3"></img>
          </div>
        </div>

        <div className="text-center " style={{ marginTop: "4rem" }}>
          <h2 className="text-capitalize " style={{ fontWeight: "bold" }}>
